import {TYPES_OF_TRANSFERS, TYPES_OF_ACTIVITY, CITIES} from "../const";

export const createAddEventTemplate = () => `<form class="trip-events__item  event  event--edit" action="#" method="post">
<header class="event__header">
  <div class="event__type-wrapper">
    ...
    <div class="event__type-list">
      ...
      ${TYPES_OF_TRANSFERS.map((eventType) => `<div class="event__type-item">
